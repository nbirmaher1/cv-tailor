# Cover letter standards (2026)

A cover letter accompanies the tailored CV for the same application. It must earn its place next
to a CV held to a strict relevance/accuracy bar — same discipline, different format. Read this
before drafting a cover letter, and review the draft against every rule here before finalizing.

## Structure & length
- 3-4 body paragraphs, ~250-400 words total.
- Open with the specific role and the single strongest, most concrete reason it's a fit — stated
  as fact about the candidate, not an announcement of intent. Never "I am writing to express my
  interest," never "I am excited to apply."
- Body: the 2-3 strongest, most concrete matches between the candidate's actual background (per
  the tailored content record) and this job's requirements — specific outcomes/scope, not restated
  bullet points.
- Close in one or two sentences: state what you want (the conversation/interview) and stop. No
  gratitude-for-your-time filler, no "I look forward to the opportunity to discuss further."
- Address a named hiring manager/recruiter if the job posting gives one, otherwise "Dear Hiring
  Manager,".

## Voice: must read as written by the candidate, not generated
Hard requirement, not a style preference — a hiring manager should never suspect this was
AI-written. Enforce every rule below on every draft.

- **No flattery toward the company or role.** Never praise the posting, team, or company ("this
  exciting opportunity," "your innovative team," "I'm impressed by your mission"). State fit and
  motivation as fact about the candidate, never as a compliment paid to the reader.
...
- If a style/structure reference letter was provided: match its voice and structure only — never
  carry over its old company name, role, or specific claims into the new letter.
- If company research was used: cite only what was actually found, at most 1-2 signals, described
  as fact rather than admiration — never state a claim about the company that wasn't genuinely
  surfaced. If research found nothing substantive, write a strong letter from the job posting
  alone rather than inventing culture claims.

## Content quality
- **Never invent** achievements, numbers, or experience not already in the tailored content record
  or explicitly stated in the candidate's own guidance for this letter.
